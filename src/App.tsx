 ...
 return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="relative mb-8"> {/* Contêiner relativo para posicionamento absoluto do botão */}
          <h1 className="text-3xl font-bold text-gray-900 shadow-lg px-6 py-4 bg-white rounded-lg text-center">
            Controle de Chamados (Nordeste/Fácil)
          </h1>
          <button
            onClick={handleLogout}
            className="absolute right-0 top-1/2 transform -translate-y-1/2 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
          >
            Sair
          </button>
        </div>
